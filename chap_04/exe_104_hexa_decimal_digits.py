"""
The program receives from the USER a NUMBER in DECIMAL and/or HEXADECIMAL format
and returns it (displaying it) CONVERTED  in hexadecimal and/or decimal format.
"""
